...
function CadastroConvidados() {
    ...
    const handleCadastro = async () => {
        ...
        if (!nome || !telefone || !eventoId) { // Validação: Nome, telefone e ID do evento são obrigatórios
        ...
        try {
            const resposta = await fetch('http://localhost:5000/api/convidados', {
                ...
                body: JSON.stringify({ nome, telefone, email, acompanhante, evento_id: eventoId }),
            });
    ...
    return (
        <div className="convidado-container"> {/* Container principal */}
            <div className="cad-convidado"> {/* Div para o formulário */}
